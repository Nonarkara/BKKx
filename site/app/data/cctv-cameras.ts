...
// method that established it. Located cameras carry real evidence (a stream
// title naming a soi, an operator's own listing) and are placed at that
// evidence's precision — never sharpened to a false exactness.
//
