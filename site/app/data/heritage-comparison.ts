...
export const COMPARISON_SITES: ComparisonSite[] = [
  {
    ...
    propertyScale: "No proposed boundary yet; this atlas begins with 22 dispersed clusters",
    documentedFabric: "618+ units counted in mapped ensembles; a separate CPB inventory reports 1,960 units across 15 commercial sites, with overlap not yet reconciled",
...
export const BANGKOK_CLAIMS = [
  {
    ...
    evidence: "22 sourced clusters · five rowhouse types",
  },
  {
    status: "proved" as const,
    ...
    evidence: "618+ individually counted units · CPB inventory: 1,960 units across 15 sites (not added because records overlap)",
  },
  {
