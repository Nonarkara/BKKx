...
export const COMPARISON_SITES: ComparisonSite[] = [
  {
    ...
    propertyScale: "No proposed boundary yet; this atlas maps 29 dispersed corridors and reconciles 26 of 46 ONEP category-E records",
    documentedFabric: "870+ units counted in mapped ensembles; a separate CPB inventory reports 1,960 units across 15 commercial sites, with overlap not yet reconciled",
...
export const BANGKOK_CLAIMS = [
  {
    ...
    evidence: "29 sourced corridors · five rowhouse types · 26/46 official records located",
  },
  {
    status: "proved" as const,
    ...
    evidence: "870+ individually counted units · CPB inventory: 1,960 units across 15 sites (not added because records overlap)",
  },
  {
