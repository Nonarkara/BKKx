...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${world.name} — 3D atlas · KLXxC(ulture)`,
      description: `Walk ${world.name} in a 3D browser atlas. Atlas only — no Minecraft world has been generated for Kuala Lumpur.`,
      url: `/atlas/${world.id}`,
    },
  };
}
