...
export const metadata: Metadata = {
  title: "Bangkok, block by block",
  description:
    "Walk through Bangkok as a playable Minecraft city atlas, from Ratchathewi's transit spine to the historic Chao Phraya riverfront.",
};
